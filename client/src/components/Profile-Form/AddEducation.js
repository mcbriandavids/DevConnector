      ...
      <form className="form" onSubmit={onSubmit}>
        ...
        <div className="form-group">
         ...
         <div className="form-group">
          ...
          value={current} checked={current} onChange={e =>{setFormData({...formData, current: !current}), toggleDisabled(!toDateDisable)}} />{' '} Current School</p>
        </div>
        <div className="form-group">
          <h4>To Date</h4>
